...
const std::array<GroupOfProperties, 4> expectedGroups =
{
    {
        {
            { interfaces[0], properties[0], meta[0] },
            { interfaces[1], properties[1], meta[1] },
        },
        {
            { interfaces[0], properties[2], meta[0] },
            { interfaces[1], properties[0], meta[1] },
        },
        {
            { interfaces[2], properties[0], meta[0] },
            { interfaces[3], properties[1], meta[1] },
        },
        {
            { interfaces[0], properties[2], meta[0] },
            { interfaces[1], properties[1], meta[1] },
            { interfaces[2], properties[3], meta[2] },
        },
    }
};
