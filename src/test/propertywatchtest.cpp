...
{
    {
        {{paths[0], interfaces[0], properties[0]}, {meta, meta, storage[0]}},
        {{paths[0], interfaces[1], properties[1]}, {meta, meta, storage[1]}},
        {{paths[1], interfaces[0], properties[0]}, {meta, meta, storage[2]}},
        {{paths[1], interfaces[1], properties[1]}, {meta, meta, storage[3]}},
        {{paths[2], interfaces[0], properties[0]}, {meta, meta, storage[4]}},
        {{paths[2], interfaces[1], properties[1]}, {meta, meta, storage[5]}},
        {{paths[3], interfaces[0], properties[0]}, {meta, meta, storage[6]}},
        {{paths[3], interfaces[1], properties[1]}, {meta, meta, storage[7]}},
    },
};
