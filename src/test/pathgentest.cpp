...
{
    {
        std::make_tuple(paths[0], meta[0]),
        std::make_tuple(paths[1], meta[0]),
        std::make_tuple(paths[2], meta[0]),
        std::make_tuple(paths[3], meta[0]),
        std::make_tuple(paths[0], meta[1]),
        std::make_tuple(paths[1], meta[1]),
        std::make_tuple(paths[2], meta[1]),
        std::make_tuple(paths[3], meta[1]),
        std::make_tuple(paths[4], meta[0]),
        std::make_tuple(paths[5], meta[0]),
        std::make_tuple(paths[3], meta[2]),
        std::make_tuple(paths[2], meta[2]),
        std::make_tuple(paths[1], meta[2]),
        std::make_tuple(paths[0], meta[2]),
    }
};
